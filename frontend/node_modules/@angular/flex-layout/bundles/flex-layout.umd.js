...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/flex-layout/flex'),require('@angular/flex-layout/extended'),require('@angular/flex-layout/grid'),exports, require('@angular/core'), require('@angular/common'), require('@angular/flex-layout/core'), require('@angular/flex-layout/extended'), require('@angular/flex-layout/flex'), require('@angular/flex-layout/grid')) :
	typeof define === 'function' && define.amd ? define('@angular/flex-layout', ['@angular/core','@angular/flex-layout/flex','@angular/flex-layout/extended','@angular/flex-layout/grid','exports', '@angular/core', '@angular/common', '@angular/flex-layout/core', '@angular/flex-layout/extended', '@angular/flex-layout/flex', '@angular/flex-layout/grid'], factory) :
	(factory(global.ng.core,global.ng.flexLayout.flex,global.ng.flexLayout.extended,global.ng.flexLayout.grid,(global.ng = global.ng || {}, global.ng.flexLayout = {}),global.ng.core,global.ng.common,global.ng.flexLayout.core,global.ng.flexLayout.extended,global.ng.flexLayout.flex,global.ng.flexLayout.grid));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,exports,core,common,core$1,extended,flex,grid) { 'use strict';
...
FlexLayoutModule.ɵfac = function FlexLayoutModule_Factory(t) { return new (t || FlexLayoutModule)(ɵngcc0.ɵɵinject(core$1.SERVER_TOKEN), ɵngcc0.ɵɵinject(core.PLATFORM_ID)); };
FlexLayoutModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: FlexLayoutModule });
FlexLayoutModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[flex.FlexModule, extended.ExtendedModule, grid.GridModule], ɵngcc1.FlexModule, ɵngcc2.ExtendedModule, ɵngcc3.GridModule] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(FlexLayoutModule, { imports: [ɵngcc1.FlexModule, ɵngcc2.ExtendedModule, ɵngcc3.GridModule], exports: [ɵngcc1.FlexModule, ɵngcc2.ExtendedModule, ɵngcc3.GridModule] }); })();

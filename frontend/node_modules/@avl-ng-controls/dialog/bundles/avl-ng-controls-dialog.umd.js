(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/cdk/a11y'),require('@angular/common'),require('@avl-controls/ng-binders'),require('@avl-ng-controls/navigation'),require('@angular/forms'),exports, require('@angular/core'), require('@angular/common'), require('@angular/cdk/a11y'), require('@angular/forms'), require('@avl-controls/ng-binders'), require('@avl-controls/core/dist/avl-icon-button/avl-icon-button'), require('@avl-controls/core/dist/avl-tooltip/avl-tooltip'), require('@avl-controls/core/dist/avl-button/avl-button'), require('@avl-ng-controls/navigation')) :
    typeof define === 'function' && define.amd ? define('@avl-ng-controls/dialog', ['@angular/core','@angular/cdk/a11y','@angular/common','@avl-controls/ng-binders','@avl-ng-controls/navigation','@angular/forms','exports', '@angular/core', '@angular/common', '@angular/cdk/a11y', '@angular/forms', '@avl-controls/ng-binders', '@avl-controls/core/dist/avl-icon-button/avl-icon-button', '@avl-controls/core/dist/avl-tooltip/avl-tooltip', '@avl-controls/core/dist/avl-button/avl-button', '@avl-ng-controls/navigation'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.cdk.a11y,global.ng.common,global.avlControls.ngBinders,global.avlNgControls.navigation,global.ng.forms,(global['avl-ng-controls'] = global['avl-ng-controls'] || {}, global['avl-ng-controls'].dialog = {}), global.ng.core, global.ng.common, global.ng.cdk.a11y, global.ng.forms, global.ngBinders, null, null, null, global.navigation));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,exports, core, common, a11y, forms, ngBinders, avlIconButton, avlTooltip, avlButton, navigation) { 
var _c0 = ["element"];
var _c1 = ["optionForm"];
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AvlDialogModule, { declarations: [AvlDialogComponent,
        ...
        AvlDialogFooterComponent,
        AvlDialogContentComponent,
        AvlAboutDialogComponent], imports: [ɵngcc2.CommonModule, ɵngcc3.AvlNgBindersModule, ɵngcc4.AvlNavigationModule, ɵngcc1.A11yModule, ɵngcc5.FormsModule, ɵngcc5.ReactiveFormsModule], exports: [AvlDialogComponent,
        AvlDialogHeaderComponent,
        AvlDialogFooterComponent,
        AvlDialogContentComponent,
        AvlAboutDialogComponent] }); })();

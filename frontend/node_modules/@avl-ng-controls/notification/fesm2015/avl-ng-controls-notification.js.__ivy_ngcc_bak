...
const NOTIFICATION_TYPE_MAPPINGS = {
    [0]: 'error',
    [1]: 'warning',
    [2]: 'info',
    [3]: 'ok',
...
let AvlNotificationDialogComponent = class AvlNotificationDialogComponent {
    ...
    translatePageSizeOptions(options) {
        return __awaiter$2(this, void 0, void 0, function* () {
            return yield Promise.all(options.map((option) => __awaiter$2(this, void 0, void 0, function* () { return yield this.translatePageSizeOption(option); })));
        });
    }
    ...
    translateColumns(column) {
        return __awaiter$2(this, void 0, void 0, function* () {
            return yield Promise.all(column.map((item) => __awaiter$2(this, void 0, void 0, function* () { return yield this.translateColumnItem(item); })));
        });
    }
...
let AvlNotificationModule = class AvlNotificationModule {
};

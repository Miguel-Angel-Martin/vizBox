...
export declare class AvlAppBarComponent implements OnInit {
     ...
     * @hidden
     */
    onApplicationListChanged(apps: unknown): void;
    /** @hidden */
    ngOnInit(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<AvlAppBarComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<AvlAppBarComponent, "avl-app-bar", never, { "currentApplication": "currentApplication"; "responsive": "responsive"; "mobile": "mobile"; "homePageUrl": "homePageUrl"; "appLogo": "appLogo"; "applications": "applications"; "fixed": "fixed"; }, { "applicationListChange": "applicationListChange"; "currentApplicationChange": "currentApplicationChange"; "burgerClicked": "burgerClicked"; }, never, ["*", "avl-overflow-menu[slot=menu]"]>;
}

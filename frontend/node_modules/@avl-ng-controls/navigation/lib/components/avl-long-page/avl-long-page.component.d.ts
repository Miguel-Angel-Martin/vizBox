...
export declare class AvlLongPageComponent implements AfterViewInit, OnDestroy {
   ...
   */
    ...
    */
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<AvlLongPageComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<AvlLongPageComponent, "avl-long-page", never, {}, {}, ["paragraphs"], ["*"]>;
}

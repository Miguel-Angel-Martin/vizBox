...
export declare abstract class AvlAuthService {
    ...
    */
     ...
     */
    abstract refreshUserIfNeeded(): void;
    /**
    * Read user from session storage
    */
    abstract readUserFromSessionStorage(): User;
    /**
    * Store user to session storage
    */
    abstract storeUserToSessionStorage(user: User): void;
    /**
    * Clear user from session storage
    */
    abstract clearUserFromSessionStorage(): void;
}

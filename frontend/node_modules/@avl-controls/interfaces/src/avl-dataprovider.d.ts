...
export interface ListRow extends RowBase {
     ...
     * For notifications, we have four predefined icon types that depend on the type of notification.
     * Priority list: image, icon.
     */
    icon?: string;
    badgeValue?: string;
    disabled?: boolean;
    /**
     * The unchecked icon of the icon toggle used in the item.
     * Priority list: icon toggle, right checkbox, overflow menu.
     */
    iconToggleUnchecked?: string;
    /**
     * The checked icon of the icon toggle used in the item.
     * Priority list: icon toggle, right checkbox, overflow menu.
     */
    iconToggleChecked?: string;
}

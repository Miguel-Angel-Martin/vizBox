...
export interface AvlUploadService {
   ...
   * @param progressCallback Callback function to call on each download progress event
   * @param completeCallback Callback function to call on successful download
   * @param failCallback Callback function to call on download fail
   * @returns Function that will abort download process
   */
  downloadFile(
    url: string,
    progressCallback?: (progress: AvlUploadProgressEvent) => void,

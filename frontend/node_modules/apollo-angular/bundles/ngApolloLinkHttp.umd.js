(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common/http'),exports, require('@angular/core'), require('@angular/common/http'), require('@apollo/client/core'), require('graphql'), require('extract-files'), require('rxjs'), require('@apollo/client/link/batch')) :
    typeof define === 'function' && define.amd ? define('apollo-angular/http', ['@angular/core','@angular/common/http','exports', '@angular/core', '@angular/common/http', '@apollo/client/core', 'graphql', 'extract-files', 'rxjs', '@apollo/client/link/batch'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common.http,(global.ngApollo = global.ngApollo || {}, global.ngApollo.http = {}), global.ng.core, global.ng.common.http, global.core, global.graphql, global.extractFiles, global.rxjs, global.batch));
}(this, (function (ɵngcc0,ɵngcc1,exports, i0, i1, core, graphql, extractFiles, rxjs, batch) { 'use strict';

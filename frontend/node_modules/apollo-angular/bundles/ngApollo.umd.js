(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('@apollo/client/core'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('apollo-angular', ['@angular/core','exports', '@angular/core', '@apollo/client/core', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngApollo = {}, global.ng.core, global.core, global.rxjs, global.rxjs.operators));
}(this, (function (ɵngcc0,exports, i0, core, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var QueryRef = /** @class */ (function () {
        function QueryRef(obsQuery, ngZone, options) {
            ...
            this.valueChanges = options.useInitialLoading
                ? wrapped.pipe(operators.startWith(Object.assign(Object.assign({}, this.obsQuery.getCurrentResult(false)), { error: undefined, partial: undefined, stale: true })))
                : wrapped;
        ...
        QueryRef.prototype.getCurrentResult = function () {
        ...
        QueryRef.prototype.setVariables = function (variables) {
            return this.obsQuery.setVariables(variables);
        };
        return QueryRef;
    }());

    var APOLLO_FLAGS = new i0.InjectionToken('APOLLO_FLAGS');
    var APOLLO_OPTIONS = new i0.InjectionToken('APOLLO_OPTIONS');
    var APOLLO_NAMED_OPTIONS = new i0.InjectionToken('APOLLO_NAMED_OPTIONS');

    var ApolloBase = /** @class */ (function () {
        function ApolloBase(ngZone, flags, _client) {
            this.ngZone = ngZone;
            this.flags = flags;
    ...
    var Apollo = /** @class */ (function (_super) {
        ...
        function Apollo(_ngZone, apolloOptions, apolloNamedOptions, flags) {
            var _this = _super.call(this, _ngZone, flags) || this;
        ...
        Apollo.prototype.createDefault = function (options) {
            ...
            return this.setClient(new core.ApolloClient(options));
        };
        /**
        ...
        Apollo.prototype.createNamed = function (name, options) {
            ...
            this.map.set(name, new ApolloBase(this._ngZone, this.flags, new core.ApolloClient(options)));
        };
        /**
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Apollo, [{
    ...
    Apollo.ctorParameters = function () { return [
        { type: i0.NgZone },
        { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [APOLLO_OPTIONS,] }] },
        { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [APOLLO_NAMED_OPTIONS,] }] },
        { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [APOLLO_FLAGS,] }] }
    ]; };
...
Query.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: Query, factory: function (t) { return Query.ɵfac(t); } });
...
Mutation.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: Mutation, factory: function (t) { return Mutation.ɵfac(t); } });
...
Subscription.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: Subscription, factory: function (t) { return Subscription.ɵfac(t); } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Subscription, [{
    ...
    exports.APOLLO_FLAGS = APOLLO_FLAGS;
